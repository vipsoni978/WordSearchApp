...
var Grid = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(Grid, [{
    ...
    value: function getCellsInRange(firstLetter, currentLetter) {
      ...
      if (firstLetter.y === currentLetter.y) {
        for (var i = firstLetter.x; i <= currentLetter.x; i++) {
          cellsInRange.push(this.body.querySelector("td[data-x=\"".concat(i, "\"][data-y = \"").concat(currentLetter.y, "\"]")));
        }
      } else if (firstLetter.x === currentLetter.x) {
        for (var _i = firstLetter.y; _i <= currentLetter.y; _i++) {
          cellsInRange.push(this.body.querySelector("td[data-x=\"".concat(currentLetter.x, "\"][data-y = \"").concat(_i, "\"]")));
        }
        ...
        for (var _i2 = 0; _i2 <= delta; _i2++) {
          cellsInRange.push(this.body.querySelector("td[data-x=\"".concat(firstLetter.x + _i2, "\"][data-y = \"").concat(firstLetter.y + _i2, "\"]")));
        }
      }
    ...
    value: function renderGrid(gridSize, wordGrid) {
      ...
      this.body = body; // creates a <table> element and a <tbody> element
      ...
      tbl.setAttribute("border", "1"); //Handlers
      ...
      tbl.addEventListener("mouseup", function (event) {
        ...
        if (_this.words.indexOf(selectedWord) !== -1) {
          ...
          _this.selectedItems.forEach(function (items) {
            return items.classList.remove("selected");
          });
        }
